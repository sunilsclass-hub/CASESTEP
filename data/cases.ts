  ...
  steps: [
    {
      ...
      media: { type: 'image', caption: 'Placeholder: OPD photograph of the patient (to be added).' },
      bullets: [
    ...
    },
    {
      ...
      media: { type: 'image', caption: 'Placeholder: monofilament foot-sensation testing technique.' },
    },
    {
      id: 'decision-invest',
      kind: 'decision',
    ...
    },
    {
      ...
      media: { type: 'video', caption: 'Placeholder: short counseling demonstration video (to be added).' },
    },
    {
      id: 'reflection',
      kind: 'reflection',
  ...
  steps: [
    {
      ...
      media: { type: 'image', caption: 'Placeholder: correct BP measurement setup at a health camp.' },
    },
    {
      id: 'decision-confirm',
      kind: 'decision',
  ...
  steps: [
    {
      ...
      media: { type: 'image', caption: 'Placeholder: sub-centre antenatal registration.' },
    },
    {
      id: 'history',
      kind: 'history',
    ...
    },
    {
      ...
      media: { type: 'video', caption: 'Placeholder: danger-sign counseling demonstration video.' },
    },
    {
      id: 'reflection',
      kind: 'reflection',
