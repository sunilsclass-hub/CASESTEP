  ...
  steps: [
    {
      ...
      media: { type: 'image', caption: 'Placeholder: postnatal home visit / sub-centre assessment.' },
    },
    {
      id: 'history',
      kind: 'history',
    ...
    },
    {
      ...
      media: { type: 'video', caption: 'Placeholder: breastfeeding attachment assessment video.' },
    },
    {
      id: 'decision',
      kind: 'decision',
  ...
  steps: [
    {
      ...
      media: { type: 'image', caption: 'Placeholder: child being assessed at the OPD.' },
    },
    {
      id: 'history',
      kind: 'history',
  ...
  steps: [
    {
      ...
      media: { type: 'image', caption: 'Placeholder: growth chart / MCP card with plotted points.' },
    },
    {
      id: 'history',
      kind: 'history',
  ...
  steps: [
    {
      ...
      media: { type: 'image', caption: 'Placeholder: field investigation / larval survey.' },
    },
    {
      id: 'reasoning',
      kind: 'reasoning',
    ...
    },
    {
      ...
      media: { type: 'image', caption: 'Placeholder: epidemic curve and spot map.' },
    },
    {
      id: 'community',
      kind: 'community',
...
const environmental: Case = {
  ...
  steps: [
    ...
    },
    {
      ...
      media: { type: 'image', caption: 'Placeholder: chest radiograph with silicotic nodules.' },
    },
    {
      id: 'reasoning',
      kind: 'reasoning',
